...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dummyImages = [
            'kiwi.png' => 'キウイ',
            'strawberry.png' => 'ストロベリー',
            'orange.png' => 'オレンジ',
            'watermelon.png' => 'スイカ',
            'peach.png' => 'ピーチ',
            'muscat.png' => 'シャインマスカット',
            'pineapple.png' => 'パイナップル',
            'grapes.png' => 'ブドウ',
            'banana.png' => 'バナナ',
            'melon.png' => 'メロン',
        ];

        foreach ($dummyImages as $imageName => $productName) {
            $imagePath = 'images/' . $imageName;
            if (!Storage::exists('public/' . $imagePath)) {
                Storage::put('public/' . $imagePath, file_get_contents(storage_path('fruits-img/' . $imageName)));
            }
            ...
            foreach ($seasonMappings[$productName] as $seasonId) {
